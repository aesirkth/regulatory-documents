...
\begin{enumerate}
  ...
  \item They have recently (in the past calendar year) been a student at KTH Royal Institute of Technology. % Maybe?
\end{enumerate}

\subsection{Period} \label{sec:membershipPeriod}
The membership periods are either the spring period or the fall period, each spanning half of one calendar year:
...
\begin{enumerate}
  ...
  \item Members can pay for both the spring period and fall period if currently in the spring period.
  \item Members can only pay for the fall period if currently in the fall period.
\end{enumerate}
