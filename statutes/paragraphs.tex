...
\begin{enumerate}
  ...
  \item Members of the board be members of the association. If a member of the board is no longer a member of the association, their role will be expired.
...
\begin{enumerate}
  ...
  \item Auditors must be members of the association. If an auditor is no longer a member of the association, their role will be expired.
...
\begin{enumerate}
  ...
  \item They should create a final report and recommendation to the spring meeting during the year \textit{after} their elected year has ended as noted in~\ref{sec:auditorYear}
\end{enumerate}
